...
export class ObservableDefaultApi {
  ...
  ): Observable<HttpInfo<Array<ChannelGet200ResponseInner>>> {
        ...
        mergeMap((response: ResponseContext) => {
          ...
          return middlewarePostObservable.pipe(
            map((rsp: ResponseContext) =>
              this.responseProcessor.channelGetWithHttpInfo(rsp)
            )
          );
        })
      );
  ...
  public channelGet(
    _options?: Configuration
  ): Observable<Array<ChannelGet200ResponseInner>> {
    return this.channelGetWithHttpInfo(_options).pipe(
      map(
        (apiResponse: HttpInfo<Array<ChannelGet200ResponseInner>>) =>
          apiResponse.data
      )
    );
  }
  ...
  public channelIdDeleteWithHttpInfo(
    ...
    const requestContextPromise = this.requestFactory.channelIdDelete(
      id,
      _options
    );
    ...
    return middlewarePreObservable
      ...
      .pipe(
        mergeMap((response: ResponseContext) => {
          ...
          return middlewarePostObservable.pipe(
            map((rsp: ResponseContext) =>
              this.responseProcessor.channelIdDeleteWithHttpInfo(rsp)
            )
          );
        })
      );
  ...
  public channelIdDelete(
    ...
    return this.channelIdDeleteWithHttpInfo(id, _options).pipe(
  ...
  public channelIdGetWithHttpInfo(
    id: string,
    _options?: Configuration
  ): Observable<HttpInfo<ChannelGet200ResponseInner>> {
    const requestContextPromise = this.requestFactory.channelIdGet(
      id,
      _options
    );
    ...
    return middlewarePreObservable
      ...
      .pipe(
        mergeMap((response: ResponseContext) => {
          ...
          return middlewarePostObservable.pipe(
            map((rsp: ResponseContext) =>
              this.responseProcessor.channelIdGetWithHttpInfo(rsp)
            )
          );
        })
      );
  ...
  public channelIdGet(
    id: string,
    _options?: Configuration
  ): Observable<ChannelGet200ResponseInner> {
    return this.channelIdGetWithHttpInfo(id, _options).pipe(
      map(
        (apiResponse: HttpInfo<ChannelGet200ResponseInner>) => apiResponse.data
      )
    );
  }
  ...
  public channelPostWithHttpInfo(
    ...
    _options?: Configuration
  ): Observable<HttpInfo<ChannelPost201Response>> {
    const requestContextPromise = this.requestFactory.channelPost(
      body,
      _options
    );
    ...
    return middlewarePreObservable
      ...
      .pipe(
        mergeMap((response: ResponseContext) => {
          ...
          return middlewarePostObservable.pipe(
            map((rsp: ResponseContext) =>
              this.responseProcessor.channelPostWithHttpInfo(rsp)
            )
          );
        })
      );
  ...
  public channelPost(
    body?: ChannelPostRequest,
    _options?: Configuration
  ): Observable<ChannelPost201Response> {
    return this.channelPostWithHttpInfo(body, _options).pipe(
      map((apiResponse: HttpInfo<ChannelPost201Response>) => apiResponse.data)
    );
  }
    ...
    return middlewarePreObservable
      ...
      .pipe(
        mergeMap((response: ResponseContext) => {
          ...
          return middlewarePostObservable.pipe(
            map((rsp: ResponseContext) =>
              this.responseProcessor.rootGetWithHttpInfo(rsp)
            )
          );
        })
      );
  ...
  public rootGet(_options?: Configuration): Observable<string> {
    return this.rootGetWithHttpInfo(_options).pipe(
      map((apiResponse: HttpInfo<string>) => apiResponse.data)
    );
  }
    ...
    return middlewarePreObservable
      ...
      .pipe(
        mergeMap((response: ResponseContext) => {
          ...
          return middlewarePostObservable.pipe(
            map((rsp: ResponseContext) =>
              this.responseProcessor.tokenPostWithHttpInfo(rsp)
            )
          );
        })
      );
  ...
  public tokenPost(
    ...
    return this.tokenPostWithHttpInfo(body, _options).pipe(
      map((apiResponse: HttpInfo<string>) => apiResponse.data)
    );
  }
}
