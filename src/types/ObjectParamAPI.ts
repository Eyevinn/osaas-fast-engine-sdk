...
export class ObjectDefaultApi {
     ...
     */
    public channelGetWithHttpInfo(param: DefaultApiChannelGetRequest = {}, options?: Configuration): Promise<HttpInfo<Array<ChannelGet200ResponseInner>>> {
     ...
     * @param param the request object
     */
    public channelGet(param: DefaultApiChannelGetRequest = {}, options?: Configuration): Promise<Array<ChannelGet200ResponseInner>> {
     ...
     * @param param the request object
     */
    public channelIdDeleteWithHttpInfo(param: DefaultApiChannelIdDeleteRequest, options?: Configuration): Promise<HttpInfo<string>> {
     ...
     * @param param the request object
     */
    public channelIdDelete(param: DefaultApiChannelIdDeleteRequest, options?: Configuration): Promise<string> {
     ...
     * @param param the request object
     */
    public channelIdGetWithHttpInfo(param: DefaultApiChannelIdGetRequest, options?: Configuration): Promise<HttpInfo<ChannelGet200ResponseInner>> {
     ...
     * @param param the request object
     */
    public channelIdGet(param: DefaultApiChannelIdGetRequest, options?: Configuration): Promise<ChannelGet200ResponseInner> {
     ...
     * @param param the request object
     */
    public channelPostWithHttpInfo(param: DefaultApiChannelPostRequest = {}, options?: Configuration): Promise<HttpInfo<ChannelPost201Response>> {
     ...
     * @param param the request object
     */
    public channelPost(param: DefaultApiChannelPostRequest = {}, options?: Configuration): Promise<ChannelPost201Response> {
     ...
     * @param param the request object
     */
    public tokenPostWithHttpInfo(param: DefaultApiTokenPostRequest = {}, options?: Configuration): Promise<HttpInfo<string>> {
     ...
     * @param param the request object
     */
    public tokenPost(param: DefaultApiTokenPostRequest = {}, options?: Configuration): Promise<string> {
